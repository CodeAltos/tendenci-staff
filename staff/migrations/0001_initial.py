...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('staff_staff', (
            ...
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='staff_staff_entity', null=True, blank=True, to=orm['entities.Entity'])),
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='staff_staff_creator', null=True, to=orm['auth.User'])),
            ('creator_username', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='staff_staff_owner', null=True, to=orm['auth.User'])),
            ...
            ('position', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Position'], null=True, blank=True)),
            ...
            ('tiny_bio', self.gf('django.db.models.fields.CharField')(max_length=140, blank=True)),
            ('question', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
        ...
        db.create_table('staff_department', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('staff', ['Department'])
        ...
        # Adding model 'StaffFile'
        db.create_table('staff_stafffile', (
        ...
        db.send_create_signal('staff', ['StaffFile'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('staff_department')

        # Deleting model 'Position'
        db.delete_table('staff_position')

        # Deleting model 'StaffFile'
        db.delete_table('staff_stafffile')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 7, 13, 57, 0, 594290)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 7, 13, 57, 0, 594042)'}),
        ...
        'staff.staff': {
            ...
            'position': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['staff.Position']", 'null': 'True', 'blank': 'True'}),
            'question': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            ...
            'tiny_bio': ('django.db.models.fields.CharField', [], {'max_length': '140', 'blank': 'True'}),
