...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Staff.creator'
        db.alter_column(u'staff_staff', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Staff.allow_user_view'
        db.alter_column(u'staff_staff', 'allow_user_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Staff.entity'
        db.alter_column(u'staff_staff', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['entities.Entity'], null=True))

        # Changing field 'Staff.owner'
        db.alter_column(u'staff_staff', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Staff.allow_anonymous_view'
        db.alter_column(u'staff_staff', 'allow_anonymous_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Staff.status'
        db.alter_column(u'staff_staff', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Staff.allow_user_edit'
        db.alter_column(u'staff_staff', 'allow_user_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Staff.allow_member_view'
        db.alter_column(u'staff_staff', 'allow_member_view', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Staff.allow_member_edit'
        db.alter_column(u'staff_staff', 'allow_member_edit', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Staff.creator'
        db.alter_column(u'staff_staff', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Staff.allow_user_view'
        db.alter_column(u'staff_staff', 'allow_user_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Staff.entity'
        db.alter_column(u'staff_staff', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['entities.Entity']))

        # Changing field 'Staff.owner'
        db.alter_column(u'staff_staff', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Staff.allow_anonymous_view'
        db.alter_column(u'staff_staff', 'allow_anonymous_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Staff.status'
        db.alter_column(u'staff_staff', 'status', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Staff.allow_user_edit'
        db.alter_column(u'staff_staff', 'allow_user_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Staff.allow_member_view'
        db.alter_column(u'staff_staff', 'allow_member_view', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Staff.allow_member_edit'
        db.alter_column(u'staff_staff', 'allow_member_edit', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'staff.staff': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'staff_staff_creator'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'staff_staff_entity'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['entities.Entity']", 'blank': 'True', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'staff_staff_owner'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'owner_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            ...
            'positions': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['staff.Position']", 'null': 'True', 'blank': 'True'}),
        ...
        u'staff.stafffile': {
            'Meta': {'ordering': "('position',)", 'object_name': 'StaffFile', '_ormbases': [u'files.File']},
