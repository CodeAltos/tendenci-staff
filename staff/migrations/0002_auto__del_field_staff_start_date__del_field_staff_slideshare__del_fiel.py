...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Staff.start_date'
        db.delete_column('staff_staff', 'start_date')

        # Deleting field 'Staff.slideshare'
        db.delete_column('staff_staff', 'slideshare')

        # Deleting field 'Staff.linkedin'
        db.delete_column('staff_staff', 'linkedin')

        # Deleting field 'Staff.facebook'
        db.delete_column('staff_staff', 'facebook')

        # Deleting field 'Staff.tiny_bio'
        db.delete_column('staff_staff', 'tiny_bio')

        # Deleting field 'Staff.get_satisfaction'
        db.delete_column('staff_staff', 'get_satisfaction')

        # Deleting field 'Staff.twitter'
        db.delete_column('staff_staff', 'twitter')

        # Deleting field 'Staff.question'
        db.delete_column('staff_staff', 'question')

        # Deleting field 'Staff.answer'
        db.delete_column('staff_staff', 'answer')

        # Deleting field 'Staff.position'
        db.delete_column('staff_staff', 'position_id')

        # Deleting field 'Staff.flickr'
        db.delete_column('staff_staff', 'flickr')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Staff.start_date'
        raise RuntimeError("Cannot reverse this migration. 'Staff.start_date' and its values cannot be restored.")

        # Adding field 'Staff.slideshare'
        db.add_column('staff_staff', 'slideshare', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Staff.linkedin'
        db.add_column('staff_staff', 'linkedin', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Staff.facebook'
        db.add_column('staff_staff', 'facebook', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Staff.tiny_bio'
        db.add_column('staff_staff', 'tiny_bio', self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True), keep_default=False)

        # Adding field 'Staff.get_satisfaction'
        db.add_column('staff_staff', 'get_satisfaction', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Staff.twitter'
        db.add_column('staff_staff', 'twitter', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Staff.question'
        db.add_column('staff_staff', 'question', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True), keep_default=False)

        # Adding field 'Staff.answer'
        db.add_column('staff_staff', 'answer', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Staff.position'
        db.add_column('staff_staff', 'position', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Position'], null=True, blank=True), keep_default=False)

        # Adding field 'Staff.flickr'
        db.add_column('staff_staff', 'flickr', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 7, 13, 58, 28, 698374)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 7, 13, 58, 28, 698244)'}),
        ...
        'staff.staff': {
            ...
            'create_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'staff_staff_creator'", 'null': 'True', 'to': "orm['auth.User']"}),
            'creator_username': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'cv': ('django.db.models.fields.TextField', [], {}),
            'department': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['staff.Department']", 'null': 'True', 'blank': 'True'}),
